...
from isaaclab_tasks.manager_based.manipulation.high_dynamic_lift.dual_reach_env_cfg import DualArmReachEnvCfg
...
@configclass
class HighDynamicDualAirbotEnvCfg(DualArmReachEnvCfg):
